...
if __name__ == "__main__":
    dataset_veri = VeRi("/mnt/Data/dataset/ReiD/VeRi")
    transform = T.Compose(
        [
            T.Resize((112, 112)),
            T.ToTensor(),
    ...
    train_loader = DataLoader(ImageDataset(dataset_veri.train, transform), batch_size=2)
    for img, pid, camid, path in train_loader:
        print(camid)
        break
    pass